package com.example.restappimobile.activities.client.address.map
    ...
    private fun onCameraMove(){
        googleMap?.setOnCameraIdleListener {
            ...
            try {
                ...
                city = addressList[0].locality //CIUDAD DONDE ESTAMOS LOCALIZADOS
                country = addressList[0].countryName //PAIS DONDE ESTAMOS LOCALIZADOS
                address = addressList[0].getAddressLine(0) //CALLE DONDE ESTAMOS LOCALIZADOS
