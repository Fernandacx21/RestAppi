...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun register(){
        ...
        if (isValidForm(nombre = nombre,apellidos = apellidos,email = email, telefono = telefono, password = password, confirmPassword = confirmPassword)){
    ...
    private fun isValidForm(nombre: String,
                            apellidos: String,
                            email: String,
                            telefono: String,
                            password: String,
        ...
        if(telefono.isBlank()){
            Toast.makeText(this, "Debes ingresar un número de telefono", Toast.LENGTH_SHORT).show()
            return false
        }
        if(password.isBlank()){
        ...
        if(confirmPassword.isBlank()){
            Toast.makeText(this, "Debes ingresar el confirmPassword", Toast.LENGTH_SHORT).show()
            return false
        }
