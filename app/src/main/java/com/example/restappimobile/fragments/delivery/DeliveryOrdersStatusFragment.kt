package com.example.restappimobile.fragments.delivery
...
import com.example.restappimobile.adapters.OrdersDeliveryAdapter
...
class DeliveryOrdersStatusFragment : Fragment() {
    ...
    private fun getOrders(){
        ordersProvider?.getOrdersByDeliveryAndStatus(user?.id_costumer!!,status)?.enqueue(object : Callback<ArrayList<Order>> {
